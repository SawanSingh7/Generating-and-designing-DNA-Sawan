...
parser.add_argument('--save_name', type=str, default="softmax_generator", help='Name to use when saving this model')
...
class SoftmaxGenerator(tf.keras.Model):
    """Generator with single softmax layer"""
    ...
    def call(self, inputs=None, training=False):
        ...
        reshaped = tf.reshape(self.latents, [self.batch_size, self.max_seq_len, self.vocab_size])
...
model = SoftmaxGenerator(args.batch_size, args.max_seq_len, vocab_size)
